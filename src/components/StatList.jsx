async function getData() {
    const res = await fetch(process.env.MAIN_URL + "/StatList");
    if (!res.ok) {
        throw new Error('StatList List Calling Fail')
    }
    return res.json();
}
...
const StatList = async () => {
    ...
    return (
        <section className="py-20">
            <div className="container mx-auto pl-28">
                <div className="flex  gap-2 flex-wrap">
                    <div className="mb-8 w-full md:w-1/2 bg-gray-900 rounded p-3 lg:w-1/5 text-center">
                    ...
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/5 bg-gray-900 rounded p-3 text-center">
                        <span className="mb-6 inline-block p-4 rounded bg-green-100">
